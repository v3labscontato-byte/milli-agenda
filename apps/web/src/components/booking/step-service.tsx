    ...
    <div className="flex flex-col">
      ...
      <div className="px-4 pb-4">
        ...
        <div className="relative">
          <Search size={16} className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-[#94A3B8]" aria-hidden="true" />
          <input
            id="svc-search"
            type="search"
            ...
            className="w-full rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] py-3 pl-9 pr-4 text-[14px] text-[#0F172A] placeholder:text-[#94A3B8] focus:border-[#2563EB] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#DBEAFE]"
          />
        </div>
      </div>
      ...
      <div className="flex-1">
        {grouped.size === 0 && (
          <p className="px-4 py-8 text-center text-[14px] text-[#94A3B8]">Nenhum serviço encontrado.</p>
        )}
          ...
          <div key={cat}>
            ...
            {services.map((svc, i) => (
              <button
                ...
                className={cn(
                  'flex w-full items-center gap-3 px-4 py-4 text-left transition-colors hover:bg-[#F8FAFC] active:bg-[#EFF6FF]',
